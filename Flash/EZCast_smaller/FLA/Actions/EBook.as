...
*/
	...
	public static var EB_AgentMatchFailed=0x10000;	
	public static var EB_AgentMatchFailedNoData=0x10001;
	public static var EB_DocumentTranslationFailed=0x10002;
	public static var EB_InternalError=0x10003;	
	public static var EB_DocumentPasswordProtected=0x10004;	
	public static var EB_UnsupportedCharset=0x10005;	
	public static var EB_OutOfMemory=0x10006;	
	public static var EB_SettingsPathUndefined=0x10007;	
	public static var EB_UnsupportedJSPopup=0x10008;	
	public static var EB_UploadFileTooLarge=0x10009;	
	public static var EB_LastErrorUnused=0x1000a;	
	public static var EB_Unknow=0x1000b;	
	...
	*/
	...
	/**
	 *@brief	get the doc load fully or not
	 *@param[in] NULL
	 *@return 
	 * - 0	: the doc not load fully
	 * - 1	: the doc load fully
	 */
	public static function GetLoadFully():Number
	{
		return ExternalInterface.call("eb_getloadfully");
	}
	 ...
	 *@return 
	 * - 0	: no error happened
	 * - others: see EB_AgentMatchFailed etc.
	 */
	public static function GetErrCode():Number
	{
		return ExternalInterface.call("eb_getErrorCode");
	}
/**
 *@}
 */
