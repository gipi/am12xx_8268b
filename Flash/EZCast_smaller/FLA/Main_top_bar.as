...
function showPrompt1(str1:String){
	...
	prompt_info._visible = true;
	prompt_info.txt1.text = str1;
	isSSIDShow = false;
}
...
function ezConnectNumberDelay(){
	...
	if(showNum == 0){
						var text_x:Number =825;
						var text_y:Number = 195;
						var str:String = " Connect to SSID ( " + MainSWF.ssid_txt + " ) ";
						trace(str);
							MainSWF.ezCleanRect(825,195,550,50);
							MainSWF.ezShowText(str, 25, 0xC9C9C9, text_x, text_y);
					}
					else{
							var text_x:Number =845;
							var text_y:Number = 195;
							var str:String = "http://"+SystemInfo.getIP(1);
							MainSWF.ezCleanRect(825,195,550,50);
							MainSWF.ezShowText(str, 25, 0xC9C9C9, text_x, text_y);
					}
}
