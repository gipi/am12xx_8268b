 ...
 *
 * @file
 * $Id: alien-config.h,v 1.38 2012/06/25 12:33:51 hugh Exp $
 */
 ...
 * they should reside inside AlienConfig_initialiseAgents()
 * . See @ref TgvDeveloping_App_Flow for
 * more information.
 *
 ...
 * typically preferences and state for a Picsel product, and are opaque to the
 * Alien application.
 *
 ...
 * are typically preferences and state for a Picsel product, and are opaque to
 ...
 * @product Typically only Picsel user interface products and applications
