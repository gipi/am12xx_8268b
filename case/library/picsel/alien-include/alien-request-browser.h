 ...
 *
 * @file
 * $Id: alien-request-browser.h,v 1.3 2010/12/16 15:16:57 yongchul Exp $
 */
...
/**
 * @defgroup TgvBrowserPrompts Scripted User Prompts
 * @ingroup TgvBrowser
 *
 ...
 * along with a @ref PicselUserRequest_Type_String event.
 */
 typedef enum PicselUserRequest_StringType
{
    PicselUserRequest_StringType_Common,  /* A generic string request */
    PicselUserRequest_StringType_Edit,    /* The returned string will be used
                                           * in an edit operation */
    PicselUserRequest_StringType_Save,    /* The returned string will be used
                                           * in a save operation */
    PicselUserRequest_StringType_Search,  /* The returned string will be used
                                           * in a search operation */

    PicselUserRequest_StringType_ForceSize = 65536
}
PicselUserRequest_StringType;
...
{
    /**
     * [in] The type of string request.
     */
    PicselUserRequest_StringType type;
