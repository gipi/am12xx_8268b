 ...
 *
 * @file
 * $Id: alien-information.h,v 1.3 2012/04/25 10:04:05 hugh Exp $
 */
...
typedef enum AlienInformation_Event
{
    ...
    /** Initialisation in progress; @c eventData is
        NULL. Another event will follow soon. */
    AlienInformation_InProgress,
