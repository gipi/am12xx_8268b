 ...
 *
 * @file
 * $Id: picsel-control.h,v 1.28 2011/01/06 14:36:05 alexms Exp $
 */
...
/**
 * The preset positions of the document to which PicselControl_panPosition()
 * can pan.
 */
typedef enum PicselControl_Position
{
    /**
     * Scroll to the top left of the current page.
     */
    PicselPan_TopLeft = 65539,

    /**
     * Scroll to the top right of the current page.
     */
    PicselPan_TopRight,

    /**
     * Scroll to the bottom left of the current page.
     */
    PicselPan_BottomLeft,

    /**
     * Scroll to the bottom right of the current page.
     */
    PicselPan_BottomRight,

    /**
     * Scroll to the centre of the current page.
     */
    PicselPan_Centre,
    ...
    /**
     * Scroll to the right of the current page.
     */
    PicselPan_Right,
    ...
    /**
     * Scroll the document down by the height of the screen.
     */
    PicselPan_View_Down,

    /**
     * Scroll the document right by the width of the screen.
     */
    PicselPan_View_Right,

    /**
     * Scroll the document up by the height of the screen.
     */
    PicselPan_View_Up,

    /**
     * Scroll the document left by the width of the screen.
     */
    PicselPan_View_Left,

    /**
     * Scroll the document down and left by the width and
     * height of the screen.
     */
    PicselPan_View_DownLeft,

    /**
     * Scroll the document down and right by the width and
     * height of the screen.
     */
    PicselPan_View_DownRight,

    /**
     * Scroll the document up and left by the width and
     * height of the screen.
     */
    PicselPan_View_UpLeft,

    /**
     * Scroll the document up and right by the width and
     * height of the screen.
     */
    PicselPan_View_UpRight,

    /**
     * Scroll to the top left of the document, note that this is only
     * effective if continuous scrolling is enabled.
     */
    PicselPan_Document_TopLeft,

    /**
     * Scroll to the top right of the document, note that this is only
     * effective if continuous scrolling is enabled.
     */
    PicselPan_Document_TopRight,

    /**
     * Scroll to the bottom left of the document, note that this is only
     * effective if continuous scrolling is enabled.
     */
    PicselPan_Document_BottomLeft,

    /**
     * Scroll to the bottom right of the document, note that this is only
     * effective if continuous scrolling is enabled.
     */
    PicselPan_Document_BottomRight,

    /**
     * Scroll to the centre of the document, note that this is only
     * effective if continuous scrolling is enabled.
     */
    PicselPan_Document_Centre,

    /**
     * Scroll to the bottom of the document, note that this is only
     * effective if continuous scrolling is enabled.
     */
    PicselPan_Document_Down,

    /**
     * Scroll to the right of the document, note that this is only
     * effective if continuous scrolling is enabled.
     */
    PicselPan_Document_Right,

    /**
     * Scroll to the top of the document, note that this is only
     * effective if continuous scrolling is enabled.
     */
    PicselPan_Document_Up,

    /**
     * Scroll to the left of the document, note that this is only
     * effective if continuous scrolling is enabled.
     */
    PicselPan_Document_Left
}
