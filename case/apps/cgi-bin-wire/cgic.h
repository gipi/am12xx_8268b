...
extern void cgiHeaderCookieSetStringforPro(char *name, char *value, 
...
extern void cgiHeaderCacheControl(char *str);
extern void cgiHeaderPragma(char *str);
extern void cgiHeaderExpires(unsigned int number);
