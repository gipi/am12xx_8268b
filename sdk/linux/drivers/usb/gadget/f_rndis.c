...
static struct usb_interface_descriptor rndis_control_intf __initdata = {
	...
	.bNumEndpoints =	1,
	.bInterfaceClass =	0xe0,//0xef win,//USB_CLASS_COMM,amos
	.bInterfaceSubClass =   0x01,//0x04 win,//USB_CDC_SUBCLASS_ACM,amos
	.bInterfaceProtocol =   0x03,//0x01 win,//USB_CDC_ACM_PROTO_VENDOR,amos
	/* .iInterface = DYNAMIC */
};
