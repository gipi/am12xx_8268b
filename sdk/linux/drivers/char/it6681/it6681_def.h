...
struct it6681_dev_data {
   ...
   //unsigned int syncdetfailcnt;
    ...
    unsigned char enable_hpd_monitor;
    unsigned short hpd_timeout_tick;

    unsigned char enable_rxdvi_monitor;
    unsigned short rxdvi_timeout_tick;
    //CBUS MSC
...
typedef struct
{
    ...
    unsigned char hpd_change_in_busyloop;
    unsigned char ppmode;
    unsigned char vers;    
    unsigned char do_oclk_cal;
    unsigned char ksvchkcnt;
    unsigned char ChkKSVListMax;
    unsigned long hdcp_tick;
    Video_State_Type m_VState;
