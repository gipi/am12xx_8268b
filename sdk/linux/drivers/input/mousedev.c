...
static const struct input_device_id mousedev_ids[] = {
	{
		...
		.keybit = { [BIT_WORD(BTN_LEFT)] = BIT_MASK(BTN_LEFT) |BIT_MASK(BTN_MIDDLE) | BIT_MASK(BTN_RIGHT) },
		.relbit = { BIT_MASK(REL_X) | BIT_MASK(REL_Y) | BIT_MASK(REL_WHEEL)  },
