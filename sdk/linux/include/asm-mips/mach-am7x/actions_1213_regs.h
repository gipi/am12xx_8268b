#ifndef  _ACTIONS_REGISTER_1213_H_
#define  _ACTIONS_REGISTER_1213_H_
/**
*@file actions_1213_regs.h
*
...
#define     CMU_WAKEUP                           __AM7X_HWREG(0xB0010000+0x3C)

#define     CMU_DEVCLKGTM                        __AM7X_HWREG(0xB0010000+0x78)
...
#define     SDR_EMODE1                           __AM7X_HWREG(0xB0070000+0x1C)
#define     SDR_EMODE2                           __AM7X_HWREG(0xB0070000+0x20)
#define     SDR_EMODE3                           __AM7X_HWREG(0xB0070000+0x24)
#define     SDR_WEIGHT                           __AM7X_HWREG(0xB0070000+0x54)
#define     SDR_WEIGHT2                          __AM7X_HWREG(0xB0070000+0xB0)
#define     SDR_CLKDLY                           __AM7X_HWREG(0xB0070000+0x5C)
...
#define     SDR_LATENCY                          __AM7X_HWREG(0xB0070000+0x58)
#define     SDR_MSTDLY                           __AM7X_HWREG(0xB0070000+0x60)
#define     SDR_TIMING2                          __AM7X_HWREG(0xB0070000+0x64)
#define     SDR_ZQTIMING                         __AM7X_HWREG(0xB0070000+0x68)
#define     SDR_ZQCS                             __AM7X_HWREG(0xB0070000+0x6C)
...
#define     SDR_CAPCLK                           __AM7X_HWREG(0xB0070000+0x48)

#define     SDR_ADDRSWAP                         __AM7X_HWREG(0xB0070000+0x4C)
#define     SDR_PRIORITY                         __AM7X_HWREG(0xB0070000+0x50)
#define     SDR_PRIORITY2                        __AM7X_HWREG(0xB0070000+0xAC)

#define     SDR_RESETD                           __AM7X_HWREG(0xB0070000+0x70)
#define     SDR_PADCTRL1                         __AM7X_HWREG(0xB0070000+0x74)
#define     SDR_PADCTRL2                         __AM7X_HWREG(0xB0070000+0x78)
#define     SDR_PADCTRL3                         __AM7X_HWREG(0xB0070000+0x7C)
...
//--------USB OTG1(1213 usb otg phy)-----------------------------------------------------
#define     USB_OTG_BASE1                         0xB0210000
#define     OTG_IRQ1                              __AM7X_HWREG(0xB0210000+0x1BC)
#define     OTG_FSMSTAT1                         __AM7X_HWREG(0xB0210000+0x1BD)
#define     OTG_CTRL1                             __AM7X_HWREG(0xB0210000+0x1BE)
#define     OTG_STAT1                             __AM7X_HWREG(0xB0210000+0x1BF)
#define     OTG_IEN1                              __AM7X_HWREG(0xB0210000+0x1C0)

#define     OTG_TAAIDLBDIS1                       __AM7X_HWREG(0xB0210000+0x1C1)
#define     OTG_TAWAITBCON1                       __AM7X_HWREG(0xB0210000+0x1C2)
#define     OTG_TBVBUSPLS1                        __AM7X_HWREG(0xB0210000+0x1C3)
#define     OTG_TBVBUSDISPLS1                     __AM7X_HWREG(0xB0210000+0x1C7)
...
//--------SPIDIF-----------------------------------------------------
#define     SPDIF_CTL                            __AM7X_HWREG(0xB01A0000+0x00)
#define     SPDIF_STAT                           __AM7X_HWREG(0xB01A0000+0x04)
#define     SPDIF_TXDAT                          __AM7X_HWREG(0xB01A0000+0x08)
#define     SPDIF_RXDAT                          __AM7X_HWREG(0xB01A0000+0x0C)
#define     SPDIF_TXCSTAT                        __AM7X_HWREG(0xB01A0000+0x10)
#define     SPDIF_RXCSTAT                        __AM7X_HWREG(0xB01A0000+0x14)
...
//--------SPI0--------------------------------------------------------
#define     SPI_CTL                              __AM7X_HWREG(0xB0238000+0x00)
#define     SPI_SIZE                             __AM7X_HWREG(0xB0238000+0x04)
#define     SPI_CLKDIV                           __AM7X_HWREG(0xB0238000+0x08)
#define     SPI_STAT                             __AM7X_HWREG(0xB0238000+0x0C)
#define     SPI_TXDAT                            __AM7X_HWREG(0xB0238000+0x10)
#define     SPI_RXDAT                            __AM7X_HWREG(0xB0238000+0x14)

//--------SPI1--------------------------------------------------------
#define     SPI1_CTL                              __AM7X_HWREG(0xB0098000+0x00)
#define     SPI1_SIZE                             __AM7X_HWREG(0xB0098000+0x04)
#define     SPI1_CLKDIV                           __AM7X_HWREG(0xB0098000+0x08)
#define     SPI1_STAT                             __AM7X_HWREG(0xB0098000+0x0C)
#define     SPI1_TXDAT                            __AM7X_HWREG(0xB0098000+0x10)
#define     SPI1_RXDAT                            __AM7X_HWREG(0xB0098000+0x14)
...
#define     GPIO_127_96OUTEN                     __AM7X_HWREG(0xB01C0000+0x24)
#define     GPIO_127_96INEN                      __AM7X_HWREG(0xB01C0000+0x28)
#define     GPIO_127_96DAT                       __AM7X_HWREG(0xB01C0000+0x2C)
...
#define     MACBaseAddress                      0xb0200000
#define     MAC_CTL                              __AM7X_HWREG(MACBaseAddress+0x0000)
#define     MAC_INT                              __AM7X_HWREG(MACBaseAddress+0x0004)
#define     MAC_PACKET_LEN                       __AM7X_HWREG(MACBaseAddress+0x0008)
#define     MAC_INTER_PACKET_LEN                 __AM7X_HWREG(MACBaseAddress+0x000C)
#define     MAC_MII_INFO                         __AM7X_HWREG(MACBaseAddress+0x0010)
#define     MAC_MII_DATA                         __AM7X_HWREG(MACBaseAddress+0x0014)
#define     MAC_ADDR0                            __AM7X_HWREG(MACBaseAddress+0x0018)
#define     MAC_ADDR1                            __AM7X_HWREG(MACBaseAddress+0x001C)
#define     MAC_ADDR2                            __AM7X_HWREG(MACBaseAddress+0x0020)
#define     MAC_ADDR3                            __AM7X_HWREG(MACBaseAddress+0x0024)
#define     MAC_ADDR4                            __AM7X_HWREG(MACBaseAddress+0x0028)
#define     MAC_TYPE_LEN_OP                      __AM7X_HWREG(MACBaseAddress+0x002C)
#define     MAC_TX_CTL                           __AM7X_HWREG(MACBaseAddress+0x0030)
#define     MAC_SDR_BASE_ADDR                    __AM7X_HWREG(MACBaseAddress+0x0034)
#define     MAC_BD_ADDR_LATCH                    __AM7X_HWREG(MACBaseAddress+0x0038)
#define     MAC_RX_PCKT_CNT                      __AM7X_HWREG(MACBaseAddress+0x003C)
#define     MAC_RX_DROP_CNT                      __AM7X_HWREG(MACBaseAddress+0x0040)
#define     MAC_RX_CRC_ERR_CNT                   __AM7X_HWREG(MACBaseAddress+0x0044)
#define     MAC_RX_NIB_CNT                       __AM7X_HWREG(MACBaseAddress+0x0048)
#define     MAC_RX_CTL_FRM_CNT                   __AM7X_HWREG(MACBaseAddress+0x004C)
#define     MAC_MBIST_ADDR                       __AM7X_HWREG(MACBaseAddress+0x0050)
#define     MAC_BD_SWAP_ADDR                     __AM7X_HWREG(MACBaseAddress+0x0054)
#define     MAC_TX_BD_PTR                        __AM7X_HWREG(MACBaseAddress+0x0058)
#define     MAC_RX_BD_PTR                        __AM7X_HWREG(MACBaseAddress+0x005C)
#define     MAC_RX_ADDR_CNT                      __AM7X_HWREG(MACBaseAddress+0x0060)
#define     MAC_RX_ERR_CNT                       __AM7X_HWREG(MACBaseAddress+0x0064)
#define     MAC_RX_FRM_CNT                       __AM7X_HWREG(MACBaseAddress+0x0068)
#define     MAC_WAKEUP                           __AM7X_HWREG(MACBaseAddress+0x006C)
#define     MAC_WAKEUP_IP                        __AM7X_HWREG(MACBaseAddress+0x0070)
#define     MAC_WAKEUP_MASK                      __AM7X_HWREG(MACBaseAddress+0x0074)
