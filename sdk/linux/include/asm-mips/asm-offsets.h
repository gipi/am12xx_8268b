...
#define THREAD_TRAPNO 872 /* offsetof(struct task_struct, thread.trap_no)	 # */
#define THREAD_TRAMP 876 /* offsetof(struct task_struct, thread.irix_trampoline)	 # */
#define THREAD_OLDCTX 880 /* offsetof(struct task_struct, thread.irix_oldctx)	 # */
...
#define MM_CONTEXT 320 /* offsetof(struct mm_struct, context)	 # */
