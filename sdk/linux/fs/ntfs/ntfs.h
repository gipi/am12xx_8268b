...
#define NTFS_MODIFY  1	//open the modified functions by yangli

#ifdef NTFS_MODIFY
#define STATUS_OK				(0)
#define STATUS_ERROR				(-1)
#define STATUS_RESIDENT_ATTRIBUTE_FILLED_MFT	(-81)
#define STATUS_KEEP_SEARCHING			(-82)
#define STATUS_NOT_FOUND			(-83)
#endif
typedef enum {
	NTFS_BLOCK_SIZE		= 512,
...
/* From fs/ntfs/mst.c */
extern int check_mst_fixup(NTFS_RECORD *b, const u32 size);
