...
extern int trace_msgs;
extern void __ntfs_trace (const char *file, int line, const char *function,
	const char *format, ...) __attribute__ ((format (printf, 4, 5)));
#define ntfs_trace(f, a...)						\
	__ntfs_trace(__FILE__, __LINE__, __func__, f, ##a)
...
#define ntfs_trace(f, a...)		do {} while (0)
