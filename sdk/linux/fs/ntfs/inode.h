...
typedef struct _ntfs_attr_3g  ntfs_attr_3g;



/**NTFS属性在内存中的结构
 * ntfs_attr - ntfs in memory attribute structure
 * @mft_no:	mft record number of the base mft record of this attribute主mft记录号
 ...
 *该结构仅应用于ntfs_{attr_}iget()/ntfs_test_inode()/ntfs_init_locked_inode() 中
