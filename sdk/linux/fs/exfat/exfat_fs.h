...
struct exfat_chunk			/* common container for all entries */
{
	__u8 type;					/* any of EXFAT_CHUNK_xxx */
	__u8 data[31];
};

/* Chunk for free space bitmap. 0x81 */
...
/* Chunk for upper-case table. 0x82 */
...
/* Chunk for directory entry. 0x85*/
...
/* Sub chunk for file name info and data clusters info. 0xc0*/
...
/*Maximum exfat_chunk_name */
#define EXFAT_MAX_CHUNKNAME 17 	/*255/15=17*/

/* Sub chunk for file name. 0xc1*/
