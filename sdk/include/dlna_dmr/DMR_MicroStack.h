...
typedef void(*DMR__ActionHandler_AVTransport_SetAVTransportURI) (void* upnptoken,unsigned int InstanceID,char* CurrentURI,char* CurrentURIMetaData,char *pUserAgent);
