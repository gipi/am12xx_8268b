...
typedef int (*DMRCallback_SetAVTransportURI)(DMR instance, void* session, char* uri, struct CdsObject* data, char *pUserAgent);
...
*/
DMR DMR_Method_Create(void* chain, unsigned short port, char* friendlyName, char* serialNumber, char* UDN, char* protocolInfo, ILibThreadPool threadPool,long (*get_player_total_time)(int),long (*get_player_play_time)(void));
